...
public class PowerRankTwo extends GuessScoresModel implements ServiceProvider {
    public Object[][] GetPowerRankData(int Season, int Week){
        ...
        //InputStream objFile = c.getClassLoader().getResourceAsStream("app/" + "PowerRank" + Season + ".db");
